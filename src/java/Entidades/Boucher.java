...
@NamedQueries({
    ...
    , @NamedQuery(name = "Boucher.findByIdEstacionamiento", query = "SELECT b FROM Boucher b WHERE b.idEstacionamiento = :idEstacionamiento")})
public class Boucher implements Serializable {
    ...
    public Boucher(Integer idBoucher, String totalBoucher, int idPago, int idEnvio, int idEstacionamiento) {
        this.idBoucher = idBoucher;
